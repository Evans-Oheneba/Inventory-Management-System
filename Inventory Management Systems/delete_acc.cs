...
{
    public partial class delete_acc : Form
    {
        public delete_acc()
        {
            InitializeComponent();
        ...
        {
            string sql = "DELETE FROM accessories WHERE id=@id";
            ...
            try
            {
                ...
                DialogResult result = MessageBox.Show("Are you sure you want to delete this accessory", "Delete Accessory", MessageBoxButtons.YesNoCancel);
