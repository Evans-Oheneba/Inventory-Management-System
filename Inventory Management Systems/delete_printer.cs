...
{
    public partial class delete_printer : Form
    {
        public delete_printer()
        {
            InitializeComponent();
        }
        ...
        {
            string sql = "DELETE FROM scanners_printers WHERE id=@id";
            ...
            try
            {
                ...
                DialogResult result = MessageBox.Show("Are you sure you want to delete this device", "Delete Device", MessageBoxButtons.YesNoCancel);
        ...
        private void delete_printer_Load(object sender, EventArgs e)
        {
